        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <GlassCard className="p-8 sm:p-12 mb-16" glow="primary">
              <p className="text-lg sm:text-xl text-foreground/90 leading-relaxed text-center font-medium">
                We exist to create a compassionate sanctuary for humanity during the greatest 
                economic transformation in history. As artificial intelligence reshapes the world 
                of work, we stand with those affected — offering support, resources, and community 
                to help navigate uncertainty with dignity and hope.
              </p>
