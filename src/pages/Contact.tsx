...
const contactCards = [{
  ...
  description: "Do you have a special story you think will inspire others and you would like to share with us?\n\nStep 1. Write your story and send to the email below.\nStep 2. If your story is chosen, we will set up an interview with you and podcast your story to the public.",
      ...
      <section className="min-h-screen pt-32 pb-24 px-4">
        <div className="mx-auto max-w-6xl">
          ...
          duration: 0.8
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Choose the best way to reach us based on your needs.</p>
          </motion.div>
