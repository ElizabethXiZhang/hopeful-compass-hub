...
const contactCards = [
  ...
  },
  {
    ...
    description:
      "Do you have a special and inspiring story to share but you would like to share with us anonymously?\n\nYou can write us at the email below. We will publish your story for you, anonymously.",
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            <h1 className="font-display text-5xl font-bold text-foreground sm:text-6xl mb-6 relative inline-block">
              Contact Us<span className="gradient-text">Us</span>
              <motion.span
