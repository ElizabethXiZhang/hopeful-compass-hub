...
const formSchema = z.object({
  ...
  }).min(16, "Age must be at least 16").max(120, "Please enter a valid age"),
  ...
  }).min(0, "Years of service cannot be negative").max(60, "Please enter a valid number"),
...
const Community = () => {
  ...
  return <Layout>
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none">
        ...
        repeat: Infinity,
        ease: "easeInOut"
      }} className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[180%] h-[80vh]" style={{
      ...
      <section className="min-h-screen pt-32 pb-24 px-4">
        <div className="mx-auto max-w-2xl">
          <AnimatePresence mode="wait">
            {!isSuccess ? <motion.div key="form" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            duration: 0.5
                ...
                delay: 0.2
                  ...
                  <p className="text-muted-foreground text-lg max-w-md mx-auto">Join the force for global initiatives. 
Contribute to community statistics. 
Each one of you, each voice, each vote - matters. </p>
                </div>
                ...
                <GlassCard className="p-8 sm:p-10" glow="primary">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="name" placeholder="How should we call you?" value={formData.name} onChange={e => handleChange("name", e.target.value)} onBlur={() => handleBlur("name")} className="bg-white/5 border-white/10 focus:border-primary" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="age" type="number" placeholder="Your age" value={formData.age ?? ""} onChange={e => handleChange("age", e.target.value ? parseInt(e.target.value) : undefined)} onBlur={() => handleBlur("age")} className="bg-white/5 border-white/10 focus:border-primary" min={16} max={120} />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="profession" placeholder="Your profession" value={formData.profession} onChange={e => handleChange("profession", e.target.value)} onBlur={() => handleBlur("profession")} className="bg-white/5 border-white/10 focus:border-primary" />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="yearsOfService" type="number" placeholder="Years worked" value={formData.yearsOfService ?? ""} onChange={e => handleChange("yearsOfService", e.target.value ? parseInt(e.target.value) : undefined)} onBlur={() => handleBlur("yearsOfService")} className="bg-white/5 border-white/10 focus:border-primary" min={0} max={60} />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="country" placeholder="Your country" value={formData.country} onChange={e => handleChange("country", e.target.value)} onBlur={() => handleBlur("country")} className="bg-white/5 border-white/10 focus:border-primary" />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="city" placeholder="Your city" value={formData.city} onChange={e => handleChange("city", e.target.value)} onBlur={() => handleBlur("city")} className="bg-white/5 border-white/10 focus:border-primary" />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="email" type="email" placeholder="your@email.com" value={formData.email} onChange={e => handleChange("email", e.target.value)} onBlur={() => handleBlur("email")} className="bg-white/5 border-white/10 focus:border-primary" />
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.shareStory ? "yes" : "no"} onValueChange={value => handleChange("shareStory", value === "yes")} className="flex gap-6">
                  ...
                  scale: 0.98
                      ...
                      <Button type="submit" disabled={isSubmitting} className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-primary via-secondary to-accent hover:opacity-90 transition-all duration-300 shadow-[0_0_30px_-5px_hsl(var(--primary)/0.5)]">
                    ...
                    <p className="text-center text-sm text-muted-foreground">We respect your privacy. Data is stored securely and only used to build our community.</p>
                  </form>
                </GlassCard>
