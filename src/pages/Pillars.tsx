        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <h1 className="font-display text-5xl font-bold text-foreground sm:text-6xl mb-6 relative inline-block">
              Our Six <span className="gradient-text">Pillars</span>
              <motion.span
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              The foundation of our support system, designed to address every aspect of wellbeing during unemployment.
            </p>
          </motion.div>
