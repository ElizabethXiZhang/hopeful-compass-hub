        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          >
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-muted-foreground">
              Navigating meaning, stability, and peace in the AI era. You are not alone in this journey.
              Together, we find new paths forward.
            </p>
            ...
            <div className="mt-6 flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 text-muted-foreground transition-all hover:border-primary/50 hover:bg-primary/10 hover:text-primary"
