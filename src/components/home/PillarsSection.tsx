  ...
  return <section className="relative py-24 px-4">
      <div className="mx-auto max-w-4xl">
        ...
        once: true
          ...
          <h2 className="font-display text-4xl font-bold text-foreground sm:text-5xl md:text-6xl mb-6">Build Your Six <span className="gradient-text">Pillars</span></h2>
        ...
        once: true
          ...
          <GlassCard className="p-8 sm:p-10" variant="strong">
            <p className="text-lg text-foreground/90 leading-relaxed italic font-bold text-center sm:text-xl">We believe that your worth is not defined by your job title. Every person deserves dignity, support, and the opportunity to thrive—regardless of their employment status.</p>
