...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center px-4 pt-24 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        repeat: Infinity,
        ease: "easeInOut"
      }} className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[200%] h-[90vh]" style={{
        background: `
        ...
        ease: "easeInOut",
        delay: 1
      }} className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[180%] h-[75vh]" style={{
        background: `
        ...
        repeat: Infinity,
        ease: "easeInOut"
      }} className="absolute -top-20 -right-20 w-[500px] h-[500px]" style={{
        background: `
        ...
        ease: "easeInOut",
        delay: 2
      }} className="absolute -top-20 -left-20 w-[400px] h-[400px]" style={{
        background: `
        ...
        {/* Floating orbs */}
        {[...Array(5)].map((_, i) => <motion.div key={`orb-${i}`} animate={{
        y: [0, -50, 0],
        x: [0, i % 2 === 0 ? 30 : -30, 0],
        opacity: [0.5, 0.8, 0.5]
      }} transition={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(25)].map((_, i) => <motion.div key={i} className="absolute h-1 w-1 rounded-full bg-white/30" initial={{
        x: Math.random() * 100 + "%",
        y: Math.random() * 100 + "%"
      }} animate={{
        y: [null, "-20%"],
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        delay: 0.1
          ...
          <br />
          <motion.span className="inline-block gradient-text" animate={{
          y: [0, -10, 0]
        }} transition={{
          duration: 4,
          repeat: Infinity,
